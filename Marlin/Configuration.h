...
#define STRING_CONFIG_H_AUTHOR "(Stef_LaDefense)" // Who made the changes.
 ...
 * For old I3MEGA with one Z, set "NUM_Z_STEPPER_DRIVERS 1" in Configuration_adv.h
 */
#ifndef MOTHERBOARD
...
// Play a startup chime on startup/serial connection of the Trigorilla board and endstops beep
...
//Anycubic i3 Mega (15v with alim trimmer) M303 E0 S240 C10 U1
...
//Anycubic i3 Mega Ultrabase (15v with alim trimmer)
#define DEFAULT_bedKp 59.32
#define DEFAULT_bedKi 11.68
#define DEFAULT_bedKd 200.87
...
//#define USE_YMAX_PLUG // not use
//#define USE_ZMAX_PLUG // not use
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#if ENABLED(I3MEGA_HAS_NEW_EXTRUDER)
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 403.2 }
#else
 ...
 */
//#define Z_MIN_PROBE_PIN 2 // Pin 2 is the Anycubic default
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -23, -1.60 }
...
#if ENABLED(INVERT_STEEPER_DIR)
  #define INVERT_X_DIR false  // set to false for TMCxxxx
  #define INVERT_Y_DIR true   // set to true for TMCxxxx
  #define INVERT_Z_DIR true   // set to true for TMCxxxx
  #define INVERT_E1_DIR true // set to true for TMCxxxx
#else
...
#if ENABLED(INVERT_EXTRUDER_DIR)
  #define INVERT_E0_DIR true // set to true for TMCxxxx
#else
...
#define X_BED_SIZE BED_SIZE
#define Y_BED_SIZE BED_SIZE
